...
Current active test baseline 以 [Project Handoff](./PROJECT_HANDOFF.md) 為準：

- `299 tests / 299 pass / 0 fail / 0 TODO`
...
若這些文件與本文件發生狀態衝突，先以本文件確認 current summary，再回到原文件查證細節與歷史原因。
