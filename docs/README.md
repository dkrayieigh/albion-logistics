...
- Completed checkpoint: Tests-first pure catalog/resolver contract.
- Completed checkpoint: 0.5.0 crafting domain contract reconciliation.
- Current active checkpoint: Tests-first production bonus, profile validation, and material consumption contract.
...
- Special Material catalog/resolver work is completed as pure current-master coverage. It does not mean schema/storage work, writer/backup/UI integration, Crafting integration, Stable Item ID migration, or release work has started.
- 0.5.0 Crafting Domain Model is the active target decision source for production profile, LPB/RRR, batch consumption, product location-based inventory, and bounded craft-completion modules.
...
- Special material identity catalog review, tests-first pure catalog/resolver contract, and 0.5.0 crafting domain contract reconciliation are completed checkpoints.
- Tests-first production bonus, profile validation, and material consumption contract is the current active checkpoint; it does not start production integration, state/storage changes, backup/UI integration, Stable Item ID migration, 0.4.5 implementation, or release work.
